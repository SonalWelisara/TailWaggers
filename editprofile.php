...
if(isset($_POST['submit']))
  {
    ...
    //Query for data updation
     $query=mysqli_query($con, "update  reguser set username='$username', firstname='$firstname',lastname='$lastname', address='$address', email='$email', mobile='$mobile'  where id='$eid'");
